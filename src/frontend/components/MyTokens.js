      ...
      <div className="flex justify-center tokencard">
        ...
        {myTokens.length > 0 ?
          <div className="px-5 container">
            <div xs={1} md={2} lg={4} className="g-4 py-5 main">
              {myTokens.map((item, idx) => (
                <div key={idx} className="maindiv">
                  ...
                  <div className='token1'>
                    <Card.Img variant="top" className='card-img-top' src={img3} />
                    <Card.Title className="tokenH2" > {item.name}</Card.Title>
                    <Card.Body className='card-body' color="secondary">
                      ...
                      <div className="d-grid px-4">
                        <Button className='tokenBtn' onClick={() => {
                          ...
                          {isPlaying && selected === idx ? (
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" className="tokenbi bi bi-play" viewBox="0 0 16 16">
                      ...
                      <Card.Text className="tokentext mt-1">
                    ...
                    <div className='tokenFooter'>
                      <InputGroup className=" my-1">
                        <Button className='tokenBTN' onClick={() => resellItem(item)} variant="outline-primary" id="button-addon1">
                          Resell
                        </Button>
                        <Form.Control
                          onChange={(e) => {
