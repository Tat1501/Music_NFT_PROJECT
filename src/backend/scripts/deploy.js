async function main() {
  ...
  let prices = [toWei(10), toWei(20), toWei(30), toWei(40), toWei(50), toWei(60), toWei(70), toWei(8)]
  let deploymentFees = toWei(prices.length * 1)
  ...
  console.log("RoyaltyFee is:" , royaltyFee)
